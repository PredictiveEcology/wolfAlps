...
Require(c("PredictiveEcology/SpaDES.core@development", "NetLogoR"), upgrade = FALSE)
workingDirectory <- ".."
```

# Download model

This section will get the model onto your computer. If you have already downloaded this model manually, then skip this.
